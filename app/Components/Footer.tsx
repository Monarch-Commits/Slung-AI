...
export default function Footer() {
  return (
    <footer className="bg-[#4466B1] w-full text-white py-14 md:py-16 px-4 sm:px-6 md:px-10 font-sans">
      <div className="max-w-[1300px] w-full mx-auto grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-12">
        ...
        <div className="md:col-span-5">
          ...
          <div className="flex flex-col lg:flex-row gap-3">
            <input
              ...
              className="bg-[#5A79C0] border border-white/20 rounded-md px-4 font-[Syne] py-3 w-full text-white placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-white/30"
            />
