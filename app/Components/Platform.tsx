  ...
  return (
    ...
    >
      <div className="mx-auto w-full px-4 pt-12 sm:px-6 md:px-[58.5px] md:pt-[47px]">
        ...
        <div className="flex w-full flex-col gap-[21.6px] lg:flex-row">
          {/* LEFT */}
          <div className="flex max-h-[349px] w-full flex-col justify-start gap-6 sm:gap-[32px] lg:w-[364px]">
            <div className="flex flex-col gap-7 sm:gap-[28.8px]">
              {featuresData.map((item) => {
                const isActive = activeTab === item.id;

                return (
                  <div className="gap-[7.2px]" key={item.id} onClick={() => setActiveTab(item.id)}>
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="relative aspect-[787/600] max-h-[379px] w-full max-w-[708px] rounded-lg sm:w-[90%] md:w-[80%]"
            >
