...
export default function Page() {
  return (
    <div className="flex min-h-full w-full flex-col bg-white">
      <div className="mx-auto flex w-full max-w-[1026px] flex-col border border-[#E4E4E4]">
        {/* Main Container */}
        <main className="relative mx-auto max-w-[1026px] px-4 pt-12 sm:px-6 md:px-10 md:pt-15 lg:px-[69px]">
          <div className="w-full space-y-8">
            {/* Header Section */}
            <div className="text-center">
              <h1 className="mb-2 font-[Inter] text-[32px] font-bold tracking-tight">
                Welcome back
              </h1>
